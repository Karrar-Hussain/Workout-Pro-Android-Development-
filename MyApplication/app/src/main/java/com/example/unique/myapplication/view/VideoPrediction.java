...
public class VideoPrediction extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_prediction);
        ...
        yc=new YoutubeConnector(VideoPrediction.this);
    ...
    private void addClickListener(){
        lView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> av, View v, int i, long id) {
                Intent intent = new Intent(VideoPrediction.this, YoutubePlayer.class);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        new Thread(){
            public void run(){
                ...
                adapter = new CustomAdapter(vid,VideoPrediction.this);
