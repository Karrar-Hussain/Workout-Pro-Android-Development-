...
public class Change_Password extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        change_pass = (Button) findViewById(R.id.change_pass_butt);
        curr_pass = (EditText) findViewById(R.id.input_password);
    ...
    public void ChangePass() {
        ...
        Cursor c = obj.ChangePassword(curr_pass.getText().toString(), new_pass.getText().toString());
        if (c.moveToFirst()) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_change__password, menu);
        return true;
    }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                "Change_Password Page", // TODO: Define a title for the content shown.
                // TODO: If you have web page content that matches this app activity's content,
                // make sure this auto-generated web page URL is correct.
                // Otherwise, set the URL to null.
                Uri.parse("http://host/path"),
                // TODO: Make sure this auto-generated app deep link URI is correct.
                Uri.parse("android-app://com.example.unique.myapplication.view/http/host/path")
        );
